...
public class XLSFileReader{
    ...
    public void update() throws IOException{
        this.file = new File("C:\\Users\\Sasalomka\\Documents\\GitHub\\Polytech_Timetable_Bot\\data\\actualTimetable.xls");
        groupIdToColumn = new HashMap<>();
        groupIdList = new ArrayList<>();
        FileInputStream fileInputStream = new FileInputStream("C:\\Users\\Sasalomka\\Documents\\GitHub\\Polytech_Timetable_Bot\\data\\actualTimetable.xls");
